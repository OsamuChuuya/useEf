...
const Cards = ({ search }) => {
  ...
  return (
    <div className='w-[875px] h-[1325px] mx-auto flex flex-wrap mt-[40px] gap-1 p-1 '>
      {filteredProducts.slice(0, 9).map((product) => (
        <div key={product.id} className='w-[284px] h-[434px] bg-[#FFFFFF1A] shadow-[0px_3.65px_2.92px_0px_#00000040] p-[18px]'>
          ...
          <button
            onClick={add}
            className='bg-gradient-to-r from-[#671AE4] to-[#B75CFF] w-[212px] h-[36px] rounded-2xl mt-[10px]'
          >
            Buy now
          </button>
        </div>
